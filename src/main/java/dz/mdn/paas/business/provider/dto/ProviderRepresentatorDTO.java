...
public class ProviderRepresentatorDTO {
     ...
     */
    public static ProviderRepresentatorDTO fromEntity(dz.mdn.paas.business.provider.model.ProviderRepresentator providerRepresentator) {
     ...
     */
    public static ProviderRepresentatorDTO fromEntityWithRelations(dz.mdn.paas.business.provider.model.ProviderRepresentator providerRepresentator) {
