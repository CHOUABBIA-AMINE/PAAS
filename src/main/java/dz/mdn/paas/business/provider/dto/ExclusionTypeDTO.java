...
public class ExclusionTypeDTO {
     ...
     */
    public static ExclusionTypeDTO fromEntity(dz.mdn.paas.business.provider.model.ExclusionType exclusionType) {
     ...
     * Convert to entity
     */
    public dz.mdn.paas.business.provider.model.ExclusionType toEntity() {
        dz.mdn.paas.business.provider.model.ExclusionType exclusionType = 
            new dz.mdn.paas.business.provider.model.ExclusionType();
     ...
     */
    public void updateEntity(dz.mdn.paas.business.provider.model.ExclusionType exclusionType) {
