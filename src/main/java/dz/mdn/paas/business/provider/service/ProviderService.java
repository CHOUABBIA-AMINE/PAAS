...
package dz.mdn.paas.business.provider.service;
...
import dz.mdn.paas.business.provider.dto.ProviderDTO;
import dz.mdn.paas.business.provider.model.Provider;
import dz.mdn.paas.business.provider.repository.EconomicDomainRepository;
import dz.mdn.paas.business.provider.repository.EconomicNatureRepository;
...
public class ProviderService {
    ...
    private final dz.mdn.paas.system.utility.repository.FileRepository fileRepository;
    private final EconomicNatureRepository economicNatureRepository;
    private final dz.mdn.paas.common.administration.repository.CountryRepository countryRepository;
    private final dz.mdn.paas.common.administration.repository.StateRepository stateRepository;
    ...
    private void handleEconomicDomainsRelationship(ProviderDTO dto, Provider entity) {
        if (dto.getEconomicDomainIds() != null) {
            List<dz.mdn.paas.business.provider.model.EconomicDomain> economicDomains = 
