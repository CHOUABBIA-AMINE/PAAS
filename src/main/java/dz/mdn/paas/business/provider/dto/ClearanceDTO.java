...
public class ClearanceDTO {
     ...
     */
    public static ClearanceDTO fromEntity(dz.mdn.paas.business.provider.model.Clearance clearance) {
     ...
     */
    public static ClearanceDTO fromEntityWithRelations(dz.mdn.paas.business.provider.model.Clearance clearance) {
        ...
        if (clearance.getReference() != null) {
            dto.setReference(dz.mdn.paas.common.communication.dto.MailDTO.fromEntity(clearance.getReference()));
        }
