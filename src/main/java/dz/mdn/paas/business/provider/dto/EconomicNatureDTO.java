...
public class EconomicNatureDTO {
     ...
     */
    public static EconomicNatureDTO fromEntity(dz.mdn.paas.business.provider.model.EconomicNature economicNature) {
     ...
     * Convert to entity
     */
    public dz.mdn.paas.business.provider.model.EconomicNature toEntity() {
        dz.mdn.paas.business.provider.model.EconomicNature economicNature = 
            new dz.mdn.paas.business.provider.model.EconomicNature();
     ...
     */
    public void updateEntity(dz.mdn.paas.business.provider.model.EconomicNature economicNature) {
