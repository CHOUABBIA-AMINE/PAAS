...
public class ProviderExclusionDTO {
    ...
    private dz.mdn.paas.common.communication.dto.MailDTO reference;

    /**
     * Create DTO from entity
     */
    public static ProviderExclusionDTO fromEntity(dz.mdn.paas.business.provider.model.ProviderExclusion providerExclusion) {
     ...
     */
    public static ProviderExclusionDTO fromEntityWithRelations(dz.mdn.paas.business.provider.model.ProviderExclusion providerExclusion) {
        ...
        if (providerExclusion.getReference() != null) {
            dto.setReference(dz.mdn.paas.common.communication.dto.MailDTO.fromEntity(providerExclusion.getReference()));
        }
