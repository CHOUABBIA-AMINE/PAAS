...
import dz.mdn.paas.business.provider.dto.ClearanceDTO;
import dz.mdn.paas.business.provider.model.Clearance;
import dz.mdn.paas.business.provider.repository.ClearanceRepository;
import dz.mdn.paas.business.provider.repository.ProviderRepository;
import dz.mdn.paas.business.provider.repository.ProviderRepresentatorRepository;
...
public class ClearanceService {
    ...
    private final dz.mdn.paas.common.communication.repository.MailRepository mailRepository;
    ...
    private void validateBusinessRules(ClearanceDTO dto, String operation) {
        ...
        if (dto.getProviderId() != null && dto.getProviderRepresentatorId() != null) {
            ...
            Optional<dz.mdn.paas.business.provider.model.ProviderRepresentator> representator = 
