...
public class ApprovalStatusDTO {
     ...
     */
    public static ApprovalStatusDTO fromEntity(dz.mdn.paas.business.core.model.ApprovalStatus approvalStatus) {
     ...
     * Convert to entity
     */
    public dz.mdn.paas.business.core.model.ApprovalStatus toEntity() {
        dz.mdn.paas.business.core.model.ApprovalStatus approvalStatus = new dz.mdn.paas.business.core.model.ApprovalStatus();
     ...
     */
    public void updateEntity(dz.mdn.paas.business.core.model.ApprovalStatus approvalStatus) {
