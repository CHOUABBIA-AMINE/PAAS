...
public class RealizationStatusDTO {
     ...
     */
    public static RealizationStatusDTO fromEntity(dz.mdn.paas.business.core.model.RealizationStatus realizationStatus) {
     ...
     * Convert to entity
     */
    public dz.mdn.paas.business.core.model.RealizationStatus toEntity() {
        dz.mdn.paas.business.core.model.RealizationStatus realizationStatus = new dz.mdn.paas.business.core.model.RealizationStatus();
     ...
     */
    public void updateEntity(dz.mdn.paas.business.core.model.RealizationStatus realizationStatus) {
