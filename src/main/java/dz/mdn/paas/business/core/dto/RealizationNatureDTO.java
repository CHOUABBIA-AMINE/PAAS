...
public class RealizationNatureDTO {
     ...
     */
    public static RealizationNatureDTO fromEntity(dz.mdn.paas.business.core.model.RealizationNature realizationNature) {
     ...
     * Convert to entity
     */
    public dz.mdn.paas.business.core.model.RealizationNature toEntity() {
        dz.mdn.paas.business.core.model.RealizationNature realizationNature = new dz.mdn.paas.business.core.model.RealizationNature();
     ...
     */
    public void updateEntity(dz.mdn.paas.business.core.model.RealizationNature realizationNature) {
