...
public class DomainDTO {
     ...
     */
    public static DomainDTO fromEntity(dz.mdn.paas.business.plan.model.Domain domain) {
     ...
     */
    public static DomainDTO fromEntityWithRelations(dz.mdn.paas.business.plan.model.Domain domain) {
