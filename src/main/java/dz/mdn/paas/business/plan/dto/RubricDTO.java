...
public class RubricDTO {
     ...
     */
    public static RubricDTO fromEntity(dz.mdn.paas.business.plan.model.Rubric rubric) {
     ...
     */
    public static RubricDTO fromEntityWithRelations(dz.mdn.paas.business.plan.model.Rubric rubric) {
