...
public class PlannedItemDTO {
     ...
     */
    public static PlannedItemDTO fromEntity(dz.mdn.paas.business.plan.model.PlannedItem plannedItem) {
     ...
     */
    public static PlannedItemDTO fromEntityWithRelations(dz.mdn.paas.business.plan.model.PlannedItem plannedItem) {
