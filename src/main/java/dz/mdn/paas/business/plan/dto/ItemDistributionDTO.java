...
public class ItemDistributionDTO {
     ...
     */
    public static ItemDistributionDTO fromEntity(dz.mdn.paas.business.plan.model.ItemDistribution itemDistribution) {
     ...
     */
    public static ItemDistributionDTO fromEntityWithRelations(dz.mdn.paas.business.plan.model.ItemDistribution itemDistribution) {
