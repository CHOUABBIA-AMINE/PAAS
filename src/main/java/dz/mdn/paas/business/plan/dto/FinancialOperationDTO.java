...
public class FinancialOperationDTO {
     ...
     */
    public static FinancialOperationDTO fromEntity(dz.mdn.paas.business.plan.model.FinancialOperation financialOperation) {
     ...
     */
    public static FinancialOperationDTO fromEntityWithRelations(dz.mdn.paas.business.plan.model.FinancialOperation financialOperation) {
