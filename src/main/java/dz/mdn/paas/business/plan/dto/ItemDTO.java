...
public class ItemDTO {
     ...
     */
    public static ItemDTO fromEntity(dz.mdn.paas.business.plan.model.Item item) {
     ...
     */
    public static ItemDTO fromEntityWithRelations(dz.mdn.paas.business.plan.model.Item item) {
