...
package dz.mdn.paas.business.plan.dto;
...
public class BudgetModificationDTO {
     ...
     */
    public static BudgetModificationDTO fromEntity(dz.mdn.paas.business.plan.model.BudgetModification budgetModification) {
     ...
     */
    public static BudgetModificationDTO fromEntityWithRelations(dz.mdn.paas.business.plan.model.BudgetModification budgetModification) {
