...
public class ArchiveBoxDTO {
    ...
    public static ArchiveBoxDTO fromEntity(dz.mdn.paas.common.environment.model.ArchiveBox archiveBox) {
    ...
    public dz.mdn.paas.common.environment.model.ArchiveBox toEntity() {
        dz.mdn.paas.common.environment.model.ArchiveBox archiveBox = new dz.mdn.paas.common.environment.model.ArchiveBox();
    ...
    public void updateEntity(dz.mdn.paas.common.environment.model.ArchiveBox archiveBox) {
        if (this.code != null) {
            archiveBox.setCode(this.code);
        }
