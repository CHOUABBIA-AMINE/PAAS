...
public class FloorDTO {
    ...
    public static FloorDTO fromEntity(dz.mdn.paas.common.environment.model.Floor floor) {
    ...
    public dz.mdn.paas.common.environment.model.Floor toEntity() {
        dz.mdn.paas.common.environment.model.Floor floor = new dz.mdn.paas.common.environment.model.Floor();
        floor.setId(this.id);
    ...
    public void updateEntity(dz.mdn.paas.common.environment.model.Floor floor) {
        if (this.code != null) {
            floor.setCode(this.code);
        }
