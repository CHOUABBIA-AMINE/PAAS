...
public class BlocDTO {
    ...
    public static BlocDTO fromEntity(dz.mdn.paas.common.environment.model.Bloc bloc) {
    ...
    public dz.mdn.paas.common.environment.model.Bloc toEntity() {
        dz.mdn.paas.common.environment.model.Bloc bloc = new dz.mdn.paas.common.environment.model.Bloc();
        bloc.setId(this.id);
    ...
    public void updateEntity(dz.mdn.paas.common.environment.model.Bloc bloc) {
        if (this.codeAr != null) {
            bloc.setCodeAr(this.codeAr);
        }
        if (this.codeLt != null) {
