...
public class FolderDTO {
    ...
    public static FolderDTO fromEntity(dz.mdn.paas.common.environment.model.Folder folder) {
    ...
    public dz.mdn.paas.common.environment.model.Folder toEntity() {
        dz.mdn.paas.common.environment.model.Folder folder = new dz.mdn.paas.common.environment.model.Folder();
    ...
    public void updateEntity(dz.mdn.paas.common.environment.model.Folder folder) {
        if (this.code != null) {
            folder.setCode(this.code);
        }
