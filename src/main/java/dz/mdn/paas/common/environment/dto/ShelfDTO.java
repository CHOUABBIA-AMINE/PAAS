...
package dz.mdn.paas.common.environment.dto;
...
public class ShelfDTO {
    ...
    public static ShelfDTO fromEntity(dz.mdn.paas.common.environment.model.Shelf shelf) {
    ...
    public dz.mdn.paas.common.environment.model.Shelf toEntity() {
        dz.mdn.paas.common.environment.model.Shelf shelf = new dz.mdn.paas.common.environment.model.Shelf();
        shelf.setId(this.id);
    ...
    public void updateEntity(dz.mdn.paas.common.environment.model.Shelf shelf) {
        if (this.code != null) {
            shelf.setCode(this.code);
        }
    ...
    private static String getStructureName(dz.mdn.paas.common.administration.model.Structure structure) {
        // Assuming structure has name field - adjust based on actual Structure model
        return "Structure #" + structure.getId();
    }

    private static String buildRoomLocationPath(dz.mdn.paas.common.environment.model.Room room) {
