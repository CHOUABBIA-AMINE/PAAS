...
public class EmployeeDTO {
     ...
     */
    public static EmployeeDTO fromEntity(dz.mdn.paas.common.administration.model.Employee employee) {
     ...
     */
    public static EmployeeDTO fromEntityWithRelations(dz.mdn.paas.common.administration.model.Employee employee) {
