...
public class StructureTypeDTO {
     ...
     */
    public static StructureTypeDTO fromEntity(dz.mdn.paas.common.administration.model.StructureType structureType) {
     ...
     */
    public void updateEntity(dz.mdn.paas.common.administration.model.StructureType structureType) {
