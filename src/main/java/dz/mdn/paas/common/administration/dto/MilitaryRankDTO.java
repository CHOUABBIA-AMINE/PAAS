...
public class MilitaryRankDTO {
     ...
     */
    public static MilitaryRankDTO fromEntity(dz.mdn.paas.common.administration.model.MilitaryRank militaryRank) {
     ...
     */
    public static MilitaryRankDTO fromEntityWithRelations(dz.mdn.paas.common.administration.model.MilitaryRank militaryRank) {
