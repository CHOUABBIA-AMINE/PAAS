...
public class CountryDTO {
    ...
    public static CountryDTO fromEntity(dz.mdn.paas.common.administration.model.Country country) {
    ...
    public dz.mdn.paas.common.administration.model.Country toEntity() {
        dz.mdn.paas.common.administration.model.Country country = new dz.mdn.paas.common.administration.model.Country();
    ...
    public void updateEntity(dz.mdn.paas.common.administration.model.Country country) {
