...
public class JobDTO {
     ...
     */
    public static JobDTO fromEntity(dz.mdn.paas.common.administration.model.Job job) {
     ...
     */
    public dz.mdn.paas.common.administration.model.Job toEntity() {
        dz.mdn.paas.common.administration.model.Job job = 
            new dz.mdn.paas.common.administration.model.Job();
        job.setId(this.id);
     ...
     */
    public void updateEntity(dz.mdn.paas.common.administration.model.Job job) {
